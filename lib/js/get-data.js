...
FHIR.oauth2.ready().then(function(client) {
  ...
  client.request("Observation?" + query, {
    ...
    function(ob) {
      ...
      if(extents_bmi[0] > 28) extents_bmi[0] = 28;
      if(extents_bmi[1] < 32) extents_bmi[1] = 32;
      var extents_bp = [80,160];
      bp_data.forEach(d => {
      ...
      var extents_cholesterol = [35,180];
      ...
      if(extents_triglycerides[0] > 140) extents_triglycerides[0] = 140;
      if(extents_triglycerides[1] < 220) extents_triglycerides[1] = 220;
