...
FHIR.oauth2.ready().then(function(client) {
  ...
  client.request("Observation?" + query, {
    ...
    function(ob) {
      ...
      if(extents_bmi[0] > 30) extents_bmi[0] = 29;
      if(extents_bmi[1] < 30) extents_bmi[1] = 31;
      var extents_bp = [80,140];
      bp_data.forEach(d => {
      ...
      var extents_cholesterol = [35,160];
      ...
      if(extents_triglycerides[1] < 200) extents_triglycerides[1] = 200;
